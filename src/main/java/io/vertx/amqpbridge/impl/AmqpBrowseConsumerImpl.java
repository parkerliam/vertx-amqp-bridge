...
public class AmqpBrowseConsumerImpl implements MessageConsumer<JsonObject> {

    private static final Logger LOG = LoggerFactory.getLogger(AmqpBrowseConsumerImpl.class);
    ...
    public AmqpBrowseConsumerImpl(AmqpBridgeImpl bridge, ProtonConnection connection, String amqpAddress) {
        ...
        receiver.closeHandler(res -> {
            ...
            synchronized (AmqpBrowseConsumerImpl.this) {
